...
object HelloWorld {
  ...
  def getNumber(lines: String): Unit = {
    ...
    var arrBuffer = Array[Int]()
    var finalBuffer = ListBuffer[Int]()

    //var s :String = "gb3seven9five6"
    var t :Int = 99
    for (c <- lines) {

      for (i <- c.toString()) {
        try {
          var integerValue = Integer.parseInt(i.toString)
          //println(integerValue)
          arrBuffer = arrBuffer :+ integerValue
